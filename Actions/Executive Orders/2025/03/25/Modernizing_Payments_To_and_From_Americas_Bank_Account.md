<!-- source: https://www.whitehouse.gov/presidential-actions/2025/03/modernizing-payments-to-and-from-americas-bank-account/ -->
<!-- date_published: 2025-03-25T15:57:57-04:00 -->
<!-- date_accessed: 2026-06-01T01:13:02.955432+00:00 -->
...
(iv) other modern electronic payment options. Sec. 4. Exceptions and Accommodations for the Phase Out of Paper Check Disbursements and Receipts. (a) The Secretary of the Treasury, shall review and, as appropriate, revise procedures for granting limited exceptions where electronic payment and collection methods are not feasible, including exceptions for:
...
(b) Individuals or entities qualifying for an exception under this section or other applicable law shall be provided alternative payment options. Sec. 5. Implementation and Compliance of Electronic Transactions. (a) The Secretary of the Treasury, in coordination with the heads of agencies, shall develop and implement a comprehensive public awareness campaign to inform Federal payment recipients of the transition to electronic payments, including guidance on accessing and setting up digital payment options.
...
(d) The Secretary of the Treasury and the heads of agencies shall take all necessary steps to protect classified information and systems, as well as personally identifiable information and tax return information, through the implementation of this order. Sec. 6. Reporting Requirements. (a) The heads of agencies shall submit a compliance plan to the Director of the Office of Management and Budget within 90 days of the date of this order detailing their strategy for eliminating paper-based transactions.

(b) The Secretary of the Treasury shall submit an implementation report to the President through the Assistant to the President for Economic Policy within 180 days of the date of this order detailing progress on the matters set forth in this order. Sec. 7. General Provisions. (a) Nothing in this order shall be construed to impair or otherwise affect:
